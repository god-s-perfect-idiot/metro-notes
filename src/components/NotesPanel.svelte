<script>
  ...
  import { openMenu, closeMenu, setMenuClosing, menuState } from "../store/menu.js";
  ...
  function handleTouchStart(e, note) {
    ...
    longPressTimer = setTimeout(() => {
      ...
      openMenu(note, { y }, handleDeleteNote);
    }, 500);
  }
        ...
        <div class="flex flex-col gap-4">
          {#each group.notes as note (note.id)}
            <div
              ...
              class:menu-selected={showMenu && selectedNote && selectedNote.id === note.id}
